	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
				...
				<div class="set-1">
					<div class="col-md-12">
						<h3 class="inner-tittle two">Register New Employee</h3>
						<div class="grid-1">
							<div class="form-body">

								<form method="POST" class="form-horizontal" action='EmployeeController' name="frmAddUser">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input input type="text" name="empName" class="form-control"
												id="inputEmail3" placeholder="Employee Name">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<a href="javascript:void(0)"
												onclick="popupMapView(18.5321814,73.93315280000002);"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input input type="text" class="form-control"
												name="latitude"   id="addresslatitude"
